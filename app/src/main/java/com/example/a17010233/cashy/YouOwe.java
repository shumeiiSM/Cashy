...
//        String qAmt = intentReceived.getStringExtra("amt");
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(YouOwe.this);
        String thepaid = prefs.getString("paid", "no paid");
        String theamount = prefs.getString("amount", "no amount");
        String theselected = prefs.getString("selectedName", "no selected");
        String thetext = prefs.getString("text", "no text");
        String thedate = prefs.getString("date", "no date");
        ...
        if (thepaid != null && theamount != null && theselected != null && thetext != null && thedate != null) {
            ...
            Toast.makeText(YouOwe.this, "No Bill Added", Toast.LENGTH_LONG).show();
        }
